    ...
    <div id="wrap">
        <div id="container">
            ...
            <form action="${root}member/login" method="post" >
                ...
                <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=c90c783e6393c5a0e9000996e8b12e51&redirect_uri=http://193.123.228.237/member/kakaoLogin&response_type=code"/><img alt="kakaoLogin" src="${root}resources/img/kakao_login_medium_wide.png" style="width:440px; height: 50px"/></a>
            </form>
